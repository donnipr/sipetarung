...
<html lang="en">
  <head>
    ...
    <title>SI Petarung. | Admin area </title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><i class="fa fa-bank"></i> <span class="greentea">SIPETARUNG.</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="{{ route('home') }}" ><i class="fa fa-home"></i> Home <span class="fa fa-angle-double-right"></span></a>
                  </li>
                  <li><a href="{{ route('certifi.index') }}"><i class="fa fa-share-alt"></i> Management Data <span class="fa fa-angle-double-right"></span></a>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{asset('backend/production/images/img.jpg')}}" alt="">{{ Auth::user()->name }}
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li>
                    <a href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="fa fa-sign-out pull-right"> <b>Sign out</b></a>
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="{{asset('backendimages/img.jpg')}}" alt="Profile Image" /></span>
        ...
        <footer>
          <div class="pull-right">
           <P>© Copyright 2019 <a href="#" target="_blank">Dinas Pertanahan & Tata Ruang Gunungkidul</a> All Right Reserved</p>
          </div>
          <div class="pull-left">
            <p>Web developed by team IT Dispertaru GK</p>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
